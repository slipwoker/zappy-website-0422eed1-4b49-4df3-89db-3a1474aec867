document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearError(field) {
      ...
      if (sibling && sibling.classList.contains('form-error-message')) {
        sibling.remove();
      }
    }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "המקום שלנו משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '0422eed1-4b49-4df3-89db-3a1474aec867',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '0422eed1-4b49-4df3-89db-3a1474aec867';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '0422eed1-4b49-4df3-89db-3a1474aec867';
